...
function menosQueNoventa(num) {
  // Devuelve "true" si el argumento de la función "num"
...
function obtenerSaludo(nombre) {
  // Toma la string "nombre" y 
  //concatena otras string en la cadena para que tome la siguiente forma:
  // "Martin" -> "Hola Martin!"
  // Tu código:
  return "Hola" + " " + nombre + "!"
}
...
function esVocal(letra) {
  //Escribe una función que reciba una letra y, si es una vocal, 
...
switch (letra){
  case letra.lentgh != 1 : return "Dato incorrecto"
  break;
